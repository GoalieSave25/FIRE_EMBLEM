...
public class Characters 
{
    ...
    {           
    	//myrmidon
    	squad [0] = new Unit(40, 20, 16, 23, 25, 24, 18, 20, 5, new Weapon(12, 1, 60, 0, "Silver Sword"), new ImageIcon("Chara GIFs/1.gif"));
    	//mage
		...
		//knight
		squad [4] = new Unit(45, 24, 15, 22, 17, 22, 26, 18, 4, new Weapon(14, 1, 60, 0, "Silver Lance"), new ImageIcon("Chara GIFs/5.gif"));
		//fighter
		squad [5] = new Unit(45, 25, 15, 23, 22, 21, 19, 18, 5, new Weapon(12, 1, 65, 0, "Steel Axe"), new ImageIcon("Chara GIFs/6.gif"));
		//mercenary
		squad [6] = new Unit(40, 22, 15, 24, 22, 20, 21, 19, 5, new Weapon(9, 1, 85, 0, "Steel Sword"), new ImageIcon("Chara GIFs/7.gif"));
		//archer
		squad [7] = new Unit(40, 21, 15, 23, 21, 20, 20, 17, 5, new Weapon(11, 2, 75, 0, "Steel Bow"), new ImageIcon("Chara GIFs/8.gif"));
    }
